...
class PlurkAPI:
    ...
    def add_all_as_friends(self):
        try:
            ...
            logging.error(f"Cannot add all as friends: {e}")
    ...
    def get_current_user_id(self):
        try:
            ...
            logging.error(f"Cannot get current user ID: {e}")
            return None

    def is_friend(self, user_id):
        try:
            logging.info(f"Check if user '{user_id}' is in friend list...")
    ...
    def respond_post(self, pid, user_id, owner_id, content, qualifier):
        try:
            ...
            logging.error(f"Error occurred while responding a post: {e}")

    def _get_comet_channel(self):
        logging.info("Get Plurk Comet Channel")
